package net.dachi.dream.armormaterial;
...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    DREAM("dream", 7, new int[] { 2, 5, 6, 2 }, 30,
            SoundEvents.ITEM_ARMOR_EQUIP_IRON, 1.0f, 0.0f, () -> {
        return Ingredient.fromItems(ModItems.DREAM_INGOT.get());
    });
