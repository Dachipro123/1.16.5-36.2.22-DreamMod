package net.dachi.dream.world.structure.structures;
...
public class RuinedDreamPortalStructure extends Structure<NoFeatureConfig> {
    public RuinedDreamPortalStructure() {
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(Dream.MOD_ID, "ruined_dream_portal/start_pool")),
