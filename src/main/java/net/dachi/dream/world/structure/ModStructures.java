...
import net.dachi.dream.world.structure.structures.RuinedDreamPortalStructure;
...
public class ModStructures {
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> RUINED_DREAM_PORTAL =
            STRUCTURES.register("ruined_dream_portal", RuinedDreamPortalStructure::new);


    public static void setupStructures() {
        setupMapSpacingAndLand(RUINED_DREAM_PORTAL.get(),
                new StructureSeparationSettings(50,2, 1234567890),
                true);
    }
