...
import net.dachi.dream.particle.ModParticles;
...
public class DreamLighter extends Item {
    public DreamLighter(Properties properties) {
        super(new Item.Properties().group(ModItemGroup.DREAM_MOD_TAB).maxDamage(64));
    }
    @Override
